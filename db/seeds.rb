...
Friend.create(relationship: 1, added_date: '2022-10-01', user_id: 1)
Friend.create(relationship: 1, added_date: '2022-10-02', user_id: 2)
Friend.create(relationship: 1, added_date: '2022-10-03', user_id: 3)
Friend.create(relationship: 1, added_date: '2022-10-04', user_id: 4)
Friend.create(relationship: 1, added_date: '2022-10-05', user_id: 5)
...
UserPost.create(user_id: 2, post_id: 4)
UserPost.create(user_id: 3, post_id: 2)
UserPost.create(user_id: 4, post_id: 1)
UserPost.create(user_id: 5, post_id: 3)
